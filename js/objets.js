let usuarios = JSON.parse(localStorage.getItem("usuarios")) || [],
	...
	tipos = JSON.parse(localStorage.getItem("type")) || [];
...
{  
  ...
  relojEsfera.style.border = '3px solid black';
  ...
  segundos.style.border = '1px solid red';
  ...
  minutos.style.border = '1px solid black';
  ...
  horas.style.border = '1px solid black';
